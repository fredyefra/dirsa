...
@ViewScoped
@Named("consultarEquipamentoCargaMB")
public class ConsultarEquipamentoCargaMB implements Serializable {
	...
	public ConsultarEquipamentoCargaMB() {
		equipamentos = new ArrayList<Equipamento>();
	}

	@PostConstruct
	public void carregar() {
		equipamentos = consultarEquipamentoService.consultarEquipamentosCarga(this.loginMB.getUsuario());
	...
	private Usuario carregarChave(){
		Usuario usuario = this.loginMB.getUsuario();
		//OrganizacaoSaudeAeronautica organizacaoSaudeAeronautica = usuario.getOrganizacaoSaudeAeronautica();
		//Integer chave = organizacaoSaudeAeronautica.getIdOsa();
		return usuario;
	} 
